...
--
if not Balances then Balances = { [ao.id] = '1000000000000000000000' } end

if Name ~= 'Happy Game Coin' then Name = 'Happy Game Coin' end

if Ticker ~= 'HGC' then Ticker = 'HGC' end

if Denomination ~= 12 then Denomination = 12 end

if not Logo then Logo = 'iZznd6igJcXyvLfs2oE9CbqFGQwVeOdYg-VOHy_Tq10' end
